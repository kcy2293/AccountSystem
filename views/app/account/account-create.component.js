...
function accountController($scope, $http, $location, $mdToast, moment) {
  var self = this;
	...
	function buildIncomeList() {
		...
		console.log(self.account.revenueList);
		console.log(self.account.expenseList);
		...
		console.log(self.account.incomeList);
		console.log(self.account.revenueTotal, self.account.expenseTotal, self.account.incomeTotal);
	}
